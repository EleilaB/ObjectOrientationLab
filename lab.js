...
function ingredients( obj ){
  const {carb: carbs} = obj;
  const {fat: fats} = obj;
  const {protein: proteins} = obj;
  let ingredientValues = [];
  ingredientValues.push(carbs, fats, proteins);
...
const garthisTheGreat = new Wizard(`Garthis the Great`, 2000, `Achrophose`);

garthisTheGreat.castSpell();
...
let myFirstVehicle = new Vehicle(12, `green`, 98023);
...
let myFirstMotorcycle = new Motorcycle(2, `midnight black`, 200451, `Ducati`);
...
let myFirstBoat = new Boat(20, `white and yellow`, 312123, `"The Morlinger"`, `tugboat`, false);
